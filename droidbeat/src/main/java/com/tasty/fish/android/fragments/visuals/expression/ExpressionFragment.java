        ...
        IExpressionView
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        _editExpressionBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    @Override
    public void indicateError(boolean error) {
        _expressionTextView.setTextColor(error ? Color.RED : Color.WHITE);
    }
